#
#  Be sure to run `pod spec lint QingTianCtTool.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  #s.author             = { "jxrs" => "" }
  # Or just: s.author    = "jxrs"
  # s.authors            = { "jxrs" => "" }
  # s.social_media_url   = "http://twitter.com/jxrs"
  ...
  #s.source       = { :git => "http://EXAMPLE/QingTianCtTool.git", :tag => "#{s.version}" }
